...
const areArraysEqual = (firstArray, secondArray) =>
    !!(firstArray.length === secondArray.length && firstArray.every((el, secondArrIndex) => el === secondArray[secondArrIndex]));
...
// console.log(a === b) // false (Почему?) - массив в js это объект, а ссылка у объектов разная независимо от содержимого
